...
while True:
    print('\n請問要選擇 (Would you like to download): ')
    print('1. 下載一話(集) (one chapter/ episode)')
    print('2. 下載多話(集) (multiple chapters/ episodes)')
    print('請輸入編號 (Please enter your option)：')
    option = input()
    ...
    if option == '1':
        ...
        print('\n頭: 第幾話(集) (The start chapter/ episode): ')
        option_start = input()
        print('尾: 第幾話(集) (The end chapter/ episode): ')
        option_end = input()
